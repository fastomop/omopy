...
FIELD_TABLE_COLUMNS: tuple[_FieldTableColumn, ...] = (
    _FieldTableColumn(
        ...
        standard_concept=None, source_concept=None, type_concept=None,
        unique_id="person_id", domain_id=None, person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="observation_period",
        start_date="observation_period_start_date",
        end_date="observation_period_end_date",
        standard_concept=None, source_concept=None,
        type_concept="period_type_concept_id",
        unique_id="observation_period_id", domain_id=None,
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="visit_occurrence",
        start_date="visit_start_date", end_date="visit_end_date",
        standard_concept="visit_concept_id",
        source_concept="visit_source_concept_id",
        type_concept="visit_type_concept_id",
        unique_id="visit_occurrence_id", domain_id="Visit",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="visit_detail",
        start_date="visit_detail_start_date", end_date="visit_detail_end_date",
        ...
        unique_id="visit_detail_id", domain_id="Visit Detail",
        person_id="person_id",
    ),
    _FieldTableColumn(
        ...
        unique_id="condition_occurrence_id", domain_id="Condition",
        person_id="person_id",
    ),
    _FieldTableColumn(
        ...
        unique_id="drug_exposure_id", domain_id="Drug",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="procedure_occurrence",
        start_date="procedure_date", end_date=None,
        standard_concept="procedure_concept_id",
        source_concept="procedure_source_concept_id",
        type_concept="procedure_type_concept_id",
        unique_id="procedure_occurrence_id", domain_id="Procedure",
        person_id="person_id",
    ),
    _FieldTableColumn(
        ...
        unique_id="device_exposure_id", domain_id="Device",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="measurement",
        start_date="measurement_date", end_date=None,
        ...
        unique_id="measurement_id", domain_id="Measurement",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="observation",
        start_date="observation_date", end_date=None,
        ...
        unique_id="observation_id", domain_id="Observation",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="death",
        start_date="death_date", end_date=None,
        standard_concept=None, source_concept=None,
        type_concept="death_type_concept_id",
        unique_id=None, domain_id=None,
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="specimen",
        start_date="specimen_date", end_date=None,
        standard_concept="specimen_concept_id",
        source_concept=None,
        type_concept="specimen_type_concept_id",
        unique_id="specimen_id", domain_id="Specimen",
        person_id="person_id",
    ),
    _FieldTableColumn(
        ...
        standard_concept="condition_concept_id",
        source_concept=None, type_concept=None,
        unique_id="condition_era_id", domain_id="Condition",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="drug_era",
        start_date="drug_era_start_date", end_date="drug_era_end_date",
        standard_concept="drug_concept_id",
        source_concept=None, type_concept=None,
        unique_id="drug_era_id", domain_id="Drug",
        person_id="person_id",
    ),
    _FieldTableColumn(
        table_name="dose_era",
        start_date="dose_era_start_date", end_date="dose_era_end_date",
        standard_concept="drug_concept_id",
        source_concept=None, type_concept=None,
        unique_id="dose_era_id", domain_id="Drug",
        person_id="person_id",
    ),
    _FieldTableColumn(
        ...
        standard_concept=None, source_concept=None, type_concept=None,
        unique_id="payer_plan_period_id", domain_id=None,
        person_id="person_id",
    ),
)
...
_FIELDS_RESULTS: tuple[ResultFieldSpec, ...] = (
    ...
    ResultFieldSpec(result="summarised_result", result_field_name="result_id",
                    is_required=True, datatype="integer", na_allowed=False, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="cdm_name",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="group_name",
                    is_required=True, datatype="character", na_allowed=False, pair="name1"),
    ResultFieldSpec(result="summarised_result", result_field_name="group_level",
                    is_required=True, datatype="character", na_allowed=False, pair="level1"),
    ResultFieldSpec(result="summarised_result", result_field_name="strata_name",
                    is_required=True, datatype="character", na_allowed=False, pair="name2"),
    ResultFieldSpec(result="summarised_result", result_field_name="strata_level",
                    is_required=True, datatype="character", na_allowed=False, pair="level2"),
    ResultFieldSpec(result="summarised_result", result_field_name="variable_name",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="variable_level",
                    is_required=True, datatype="character", na_allowed=True, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="estimate_name",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="estimate_type",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="estimate_value",
                    is_required=True, datatype="character", na_allowed=True, pair=None),
    ResultFieldSpec(result="summarised_result", result_field_name="additional_name",
                    is_required=True, datatype="character", na_allowed=False, pair="name3"),
    ResultFieldSpec(result="summarised_result", result_field_name="additional_level",
                    is_required=True, datatype="character", na_allowed=True, pair="level3"),
    # settings (4 required fields)
    ResultFieldSpec(result="settings", result_field_name="result_id",
                    is_required=True, datatype="integer", na_allowed=False, pair=None),
    ResultFieldSpec(result="settings", result_field_name="result_type",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="settings", result_field_name="package_name",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
    ResultFieldSpec(result="settings", result_field_name="package_version",
                    is_required=True, datatype="character", na_allowed=False, pair=None),
)
